...
const onChange: UniHelper.SwiperOnChange = (ev) => {
  currentImage.value = ev.detail.current
}
// 大图预览
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="preview">
        ...
        <view class="indicator" v-if="goods?.id">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    <view class="icons">
      ...
      <navigator class="icons-button" url="/pages/cart/normalCart" open-type="navigate">
  ...
  <vk-data-goods-sku-popup
    ...
    :amount-type="0"
    :mode="mode"
    add-cart-background-color="#f1a86f"
    buy-now-background-color="#5cb89b"
    ref="skuPopupRef"
    :actived-style="{
      color: '#5cb89b',
      borderColor: '#5cb89b',
