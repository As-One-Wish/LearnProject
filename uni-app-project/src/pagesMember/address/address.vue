...
import type { DeliveryAddress } from '@/types/member'
import { getAddressListAPI, deleteAddressInfoAPI } from '@/services/profile'
import { ref } from 'vue'
import { onShow } from '@dcloudio/uni-app'

// 获取收货地址列表
const addressList = ref<DeliveryAddress[]>()
